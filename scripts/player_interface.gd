...
const CONTROL_HINT_SPACE_ICON_HEIGHT := 18.0
const CONTROL_HINT_SPACE_ICON_BASE_SIZE := Vector2(
	CONTROL_HINT_SPACE_ICON_HEIGHT * VisualStyle.SPACE_KEY_ASPECT,
	CONTROL_HINT_SPACE_ICON_HEIGHT
)
