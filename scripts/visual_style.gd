...
const PLAYER_EDGE_RATIO := 2.0 / 96.0
...
const FACING_CHV_LEN_RATIO := 0.40
...
const FACING_CHV_OUTLINE_RATIO := 0.017
...
const TRIGGER_FLASH_HOLD_SECONDS := 0.08
...
const SPACE_KEY_ASPECT := 2.4
const SPACE_KEY_SOURCE_HEIGHT := 112.0
const SPACE_KEY_SOURCE_WIDTH := SPACE_KEY_SOURCE_HEIGHT * SPACE_KEY_ASPECT
const SPACE_KEY_SOURCE_RECT := Rect2(
	128.0 - SPACE_KEY_SOURCE_WIDTH / 2.0,
	72.0,
	SPACE_KEY_SOURCE_WIDTH,
	SPACE_KEY_SOURCE_HEIGHT
)
const TUTORIAL_X_KEY_SIZE := Vector2(40.0, 40.0)
const TUTORIAL_SPACE_KEY_HEIGHT := 48.0
const TUTORIAL_SPACE_KEY_SIZE := Vector2(
	TUTORIAL_SPACE_KEY_HEIGHT * SPACE_KEY_ASPECT,
	TUTORIAL_SPACE_KEY_HEIGHT
)
const TUTORIAL_KEY_GAP := 16.0
const TUTORIAL_SPACE_KEY_GAP := 8.0
...
const COMPLETION_BOARD_FADE_SECONDS := 0.18
